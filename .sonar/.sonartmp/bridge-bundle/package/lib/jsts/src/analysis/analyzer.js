...
function serializeAst(sourceCode, filePath) {
    try {
        return (0, parsers_1.serializeInProtobuf)(sourceCode.ast);
    }
    catch (e) {
        (0, shared_1.info)(`Failed to serialize AST for file "${filePath}"`);
        return null;
    }
}
/**
