...
const { analyzeJSTS, clearTypeScriptESLintParserCaches, createAndSaveProgram, createProgramOptions, deleteProgram, initializeLinter, writeTSConfigFile, analyzeProject, } = require('@sonar/jsts');
